...
title: 보증금지킴 — 구현 계획
status: draft
upstream: [JSD-MS-001, JSD-API-001, JSD-UI-001, JSD-SCN-001, JSD-INFRA-001]
---
...
| API | [[JSD-API-001#GET/api/criteria]] · 도구 [[JSD-API-001#summarize_rights]] [[JSD-API-001#check_signals]] |
| 화면 | — |
...
| API | [[JSD-API-001#GET/api/reviews/{id}/document]] · 도구 [[JSD-API-001#read_registry]] |
| 화면 | — |
...
| API | [[JSD-API-001#POST/api/reviews]] · [[JSD-API-001#GET/api/reviews/{id}]] · [[JSD-API-001#GET/api/reviews/{id}/events]] · [[JSD-API-001#POST/api/reviews/{id}/answers]] · [[JSD-API-001#DELETE/api/reviews/{id}]] · 도구 [[JSD-API-001#ask_user]] |
...
| API | 도구 [[JSD-API-001#lookup_price]] [[JSD-API-001#lookup_building]] [[JSD-API-001#match_defaulter]] |
| 화면 | — |
...
| API | [[JSD-API-001#GET/api/reviews/{id}/report]] · [[JSD-API-001#PATCH/api/reviews/{id}/values]] · 도구 [[JSD-API-001#write_report]] |
| 화면 | — |
