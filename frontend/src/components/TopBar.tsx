    ...
    <header className="w-full border-b border-gray-200 bg-white px-4 py-3 sticky top-0 z-50 shadow-sm" data-el="1">
      <div className="max-w-6xl mx-auto flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <Link to="/" className="text-2xl font-bold text-blue-600 tracking-tight flex items-center gap-1.5 hover:text-blue-700">
            <span className="bg-blue-600 text-white rounded-lg px-2 py-0.5 text-sm">지킴</span>
            <span>보증금지킴</span>
          </Link>
          <span className="text-xs text-gray-500 border-l border-gray-300 pl-3 hidden sm:inline">
            LH 전세임대 권리분석 기준
          </span>
        </div>
        ...
        {/* 검토 대상 요약 (검토 화면일 때) */}
        {subject && (
          <div className="hidden md:flex items-center gap-2 text-sm text-gray-800 bg-gray-50 px-3 py-1.5 rounded-full border border-gray-200">
        ...
        <div className="flex items-center gap-4 text-sm">
          ...
          <Link
            to="/guide"
            className="text-gray-700 hover:text-gray-900 font-medium px-2 py-1 rounded hover:bg-gray-100 transition flex items-center gap-1"
          >
            <span>📖</span>
            <span>이용 가이드</span>
          </Link>
          ...
          <Link
            to="/criteria"
            className="text-gray-700 hover:text-gray-900 font-medium px-2 py-1 rounded hover:bg-gray-100 transition"
          >
            판정 기준
          </Link>
